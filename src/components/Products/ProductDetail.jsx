                            ...
                            <div className="row g-4">
                                ...
                                <div className="col-lg-6">
                                    ...
                                    <div className="d-flex mb-4">
                                        {
                                            Array(5).fill(0).map((_, index) => (
                                                <i key={index} className={index < product.rating ? "fa fa-star text-secondary" : "fa fa-star"}></i>
                                            ))
                                        }
                                    ...
                                    <div className="input-group quantity mb-5" style={{ 'width': '100px' }}>
                                        <div className="input-group-btn">
                                            <button className="btn btn-sm btn-minus rounded-circle bg-light border" onClick={handleDecrease} >
                                                <i className="fa fa-minus"></i>
                                            </button>
                                        </div>
                                        <input type="text" value={quantity} onChange={handleChange} className="form-control form-control-sm text-center border-0" />
                                        <div className="input-group-btn">
                                            <button className="btn btn-sm btn-plus rounded-circle bg-light border" onClick={handleIncrease}>
                                ...
                                <form action="#">
                                    ...
                                    <div className="row g-4">
                                        ...
                                        <div className="col-lg-6">
                                            <div className="border-bottom rounded">
                                                <input type="email" className="form-control border-0" placeholder="Email của bạn *" />
                                            </div>
                                        </div>
                                        <div className="col-lg-12">
                                            <div className="border-bottom rounded my-4">
                                                <textarea name="" id="" className="form-control border-0" cols="30" rows="8" placeholder="Điền vào đây với phản hồi từ bạn *" spellCheck="false"></textarea>
                                            </div>
                                        </div>
                                        <div className="col-lg-12">
                                            <div className="d-flex justify-content-between py-3 mb-5">
                                                ...
                                                <a href="#" className="btn border border-secondary text-primary rounded-pill px-4 py-3"> Gửi Phản Hồi</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                        ...
                                        <ul className="list-unstyled fruite-categorie">
                                            <li>
                                                <div className="d-flex justify-content-between fruite-name">
                                                    <a href="http://localhost:5173/product/6"><i className="fas fa-apple-alt me-2"></i>Apples</a>
                                                    <span>(3)</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="d-flex justify-content-between fruite-name">
                                                    <a href="http://localhost:5173/product/2"><i className="fas fa-apple-alt me-2"></i>Oranges</a>
                                                    <span>(5)</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="d-flex justify-content-between fruite-name">
                                                    <a href="http://localhost:5173/product/7"><i className="fas fa-apple-alt me-2"></i>Strawbery</a>
                                                    <span>(2)</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="d-flex justify-content-between fruite-name">
                                                    <a href="http://localhost:5173/product/1"><i className="fas fa-apple-alt me-2"></i>Banana</a>
                                                    <span>(8)</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="d-flex justify-content-between fruite-name">
                                                    <a href="http://localhost:5173/product/5"><i className="fas fa-apple-alt me-2"></i>Apricots</a>
                                                    <span>(5)</span>
                                                </div>
                                            </li>
                                        </ul>
